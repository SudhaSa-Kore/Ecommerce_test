...
app.get('/abandendCart/:customer',function(req,res){
	...
	var options=
 {
       ...
       method: 'POST',
       headers: {
        'Authorization' : 'Basic U3VkaGE6U3VyaWJhYnVAMTIzJDpLb3JlQDEyMzQk',
      },
      form : {
...
app.get('/promotions',function(req,res){
	...
	var options=
 {
   ...
   request(options).then(function(response){
     ...
     var options2=
     {
       url: 'https://kore02-tech-prtnr-na06-dw.demandware.net/s/SiteGenesis/dw/shop/v16_8/promotions?client_id=92739519-521e-40b7-a099-03bd7718ddb8&campaign_id=Automation', //URL to hit
       method: 'GET',
       headers: {
        'Authorization' : 'Bearer '+response.access_token,
      }
...
app.get('/hybrisAddItem',function(req,res){
  ...
  request(options).then(function(response){
     ...
     var options2=
     {
       url: 'https://kore.demo.hybris.com/rest/v2/apparel-uk/promotions?type=all&fields=promotions(title,code,promotionType,description)', //URL to hit
       method: 'GET',
       headers: {
        'Authorization' : 'Bearer '+response.access_token,
      }
